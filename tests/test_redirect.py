...
class TestRedirects:
    ...
    @allure.description('Переход на главную страницу Дзена при клике на слово Яндекс в логотипе с страницы Самоката')
    def test_redirect_yandex_logo(self, driver):
        ...
        assert is_dzen_logo_displayed, "Логотип Дзена не найден на странице — переход не выполнен"
